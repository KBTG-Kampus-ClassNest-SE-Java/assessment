...
public class LotteryService {
    ...
    public TicketsResponse getAllTickets() {
        ...
        List<String> ticketNumber = tickets.stream().map(Lottery::getTicketNumber).collect(Collectors.toList());
    ...
    public UserTicketResponse getAllUserTickets(String userID) {
        ...
        List<String> ticket = tickets.stream().map(UserTicket::getTicketNumber).collect(Collectors.toList());

        int totalAmount = tickets.size();

        int totalPrice = tickets.stream().mapToInt(UserTicket::getTicketPrice).sum();
